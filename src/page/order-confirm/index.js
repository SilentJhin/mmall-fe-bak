/*
* @Author: Jhin
* @Date:   2019-08-11 12:26:21
* @Last Modified by:   Jhin
* @Last Modified time: 2019-08-13 15:33:19
*/
...
var page = {
    ...
    loadAddressList : function(){
        ...
        _address.getAddressList(function(res){
            ...
            $('.address-con')
                .html('<p class="err-tip">地址加载失败，请刷新后重试</p>')
        })
    },
    // 处理地址列表中选中状态
    ...
    loadProductList : function(){
        ...
        _order.getProductList(function(res){
            ...
            $('.product-con')
                .html('<p class="err-tip">商品信息加载失败，请刷新后重试</p>')
        })
    },
};
$(function(){
